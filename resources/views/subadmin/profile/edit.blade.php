...
<head>
  ...
  <title>Edit Subadmin Profile</title>
...
<body>
  <section>
    <div class="container">
      ...
      <center><h2>Edit Subadmin Profile</h2></center><br>

      <!-- Personal Information Form -->
      <form id="personalInfoForm" method="POST" action="{{ route('subadmin.profile.update') }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
      ...
      <form id="passwordForm" method="POST" action="{{ route('subadmin.password.update') }}" style="margin-top: 20px;">
        @csrf
        @method('PUT')
      ...
      <form id="deleteAccountForm" method="POST" action="{{ route('subadmin.profile.destroy') }}" style="margin-top: 20px;">
        @csrf
        @method('DELETE')
