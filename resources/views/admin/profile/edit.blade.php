...
<body>
  <section>
    <div class="container">
      ...
      <center><h2>Edit Admin Profile</h2></center><br>

      <!-- Personal Information Form -->
      <form id="personalInfoForm" method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
      ...
      <form id="passwordForm" method="POST" action="{{ route('admin.password.update') }}" style="margin-top: 20px;">
        @csrf
        @method('PUT')
      ...
      <form id="deleteAccountForm" method="POST" action="{{ route('admin.profile.destroy') }}" style="margin-top: 20px;">
        @csrf
        @method('DELETE')
